...
if (!music?.url) { console.error('no music.url in shots.json'); process.exit(1); }
...
const src = path.join(DIR, 'source.webm');
...
console.log(`bed: ${need.toFixed(1)}s from ${music.credit}`);
